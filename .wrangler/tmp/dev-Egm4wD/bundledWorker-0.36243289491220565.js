...
// .wrangler/tmp/pages-xxV0aI/bundledWorker-0.36243289491220565.mjs
  ...
  route(path, app7) {
    ...
    app7.routes.map((r) => {
      ...
      if (app7.errorHandler === errorHandler) {
        ...
        handler = /* @__PURE__ */ __name2(async (c, next) => (await compose([], app7.errorHandler)(c, () => r.handler(c, next))).res, "handler");
...
var humanize = /* @__PURE__ */ __name2((times) => {
  const [delimiter, separator] = [",", "."];
  const orderTimes = times.map((v) => v.replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1" + delimiter));
  return orderTimes.join(separator);
}, "humanize");
var time32 = /* @__PURE__ */ __name2((start) => {
  const delta = Date.now() - start;
  return humanize([delta < 1e3 ? delta + "ms" : Math.round(delta / 1e3) + "s"]);
}, "time");
var colorStatus = /* @__PURE__ */ __name2(async (status) => {
...
async function log32(fn, prefix, method, path, status = 0, elapsed) {
  const out = prefix === "<--" ? `${prefix} ${method} ${path}` : `${prefix} ${method} ${path} ${await colorStatus(status)} ${elapsed}`;
  fn(out);
}
__name(log32, "log3");
__name2(log32, "log");
var logger = /* @__PURE__ */ __name2((fn = console.log) => {
  return /* @__PURE__ */ __name2(/* @__PURE__ */ __name(async function logger2(c, next) {
    const { method, url } = c.req;
    const path = url.slice(url.indexOf("/", 8));
    await log32(fn, "<--", method, path);
    const start = Date.now();
    await next();
    await log32(fn, "-->", method, path, c.res.status, time32(start));
  }, "logger2"), "logger2");
}, "logger");
...
var makeSignature = /* @__PURE__ */ __name2(async (value, secret) => {
...
var serializeSigned = /* @__PURE__ */ __name2(async (name, value, secret, opt = {}) => {
...
var generateSignedCookie = /* @__PURE__ */ __name2(async (name, value, secret, opt) => {
  let cookie;
  if (opt?.prefix === "secure") {
...
var setSignedCookie = /* @__PURE__ */ __name2(async (c, name, value, secret, opt) => {
...
__export(schema_exports, {
  bankAccounts: /* @__PURE__ */ __name2(() => bankAccounts, "bankAccounts"),
  cartItemSchema: /* @__PURE__ */ __name2(() => cartItemSchema, "cartItemSchema"),
  categories: /* @__PURE__ */ __name2(() => categories, "categories"),
  deliverySettings: /* @__PURE__ */ __name2(() => deliverySettings, "deliverySettings"),
  footerSettings: /* @__PURE__ */ __name2(() => footerSettings, "footerSettings"),
  generatedMealKitComponents: /* @__PURE__ */ __name2(() => generatedMealKitComponents, "generatedMealKitComponents"),
  generatedMealKitComponentsRelations: /* @__PURE__ */ __name2(() => generatedMealKitComponentsRelations, "generatedMealKitComponentsRelations"),
  generatedMealKits: /* @__PURE__ */ __name2(() => generatedMealKits, "generatedMealKits"),
  generatedMealKitsRelations: /* @__PURE__ */ __name2(() => generatedMealKitsRelations, "generatedMealKitsRelations"),
  insertBankAccountSchema: /* @__PURE__ */ __name2(() => insertBankAccountSchema, "insertBankAccountSchema"),
  insertCategorySchema: /* @__PURE__ */ __name2(() => insertCategorySchema, "insertCategorySchema"),
  insertDeliverySettingsSchema: /* @__PURE__ */ __name2(() => insertDeliverySettingsSchema, "insertDeliverySettingsSchema"),
  insertFooterSettingsSchema: /* @__PURE__ */ __name2(() => insertFooterSettingsSchema, "insertFooterSettingsSchema"),
  insertGeneratedMealKitComponentSchema: /* @__PURE__ */ __name2(() => insertGeneratedMealKitComponentSchema, "insertGeneratedMealKitComponentSchema"),
  insertGeneratedMealKitSchema: /* @__PURE__ */ __name2(() => insertGeneratedMealKitSchema, "insertGeneratedMealKitSchema"),
  insertMealKitComponentSchema: /* @__PURE__ */ __name2(() => insertMealKitComponentSchema, "insertMealKitComponentSchema"),
  insertMealKitSchema: /* @__PURE__ */ __name2(() => insertMealKitSchema, "insertMealKitSchema"),
  insertMediaSchema: /* @__PURE__ */ __name2(() => insertMediaSchema, "insertMediaSchema"),
  insertNavigationItemSchema: /* @__PURE__ */ __name2(() => insertNavigationItemSchema, "insertNavigationItemSchema"),
  insertNonDeliveryDaySchema: /* @__PURE__ */ __name2(() => insertNonDeliveryDaySchema, "insertNonDeliveryDaySchema"),
  insertOrderItemSchema: /* @__PURE__ */ __name2(() => insertOrderItemSchema, "insertOrderItemSchema"),
  insertOrderSchema: /* @__PURE__ */ __name2(() => insertOrderSchema, "insertOrderSchema"),
  insertProductSchema: /* @__PURE__ */ __name2(() => insertProductSchema, "insertProductSchema"),
  insertReviewSchema: /* @__PURE__ */ __name2(() => insertReviewSchema, "insertReviewSchema"),
  insertServiceCategorySchema: /* @__PURE__ */ __name2(() => insertServiceCategorySchema, "insertServiceCategorySchema"),
  insertSiteContentSchema: /* @__PURE__ */ __name2(() => insertSiteContentSchema, "insertSiteContentSchema"),
  insertSiteSettingsSchema: /* @__PURE__ */ __name2(() => insertSiteSettingsSchema, "insertSiteSettingsSchema"),
  insertStoreSchema: /* @__PURE__ */ __name2(() => insertStoreSchema, "insertStoreSchema"),
  insertUserSchema: /* @__PURE__ */ __name2(() => insertUserSchema, "insertUserSchema"),
  loginSchema: /* @__PURE__ */ __name2(() => loginSchema, "loginSchema"),
  mealKitComponents: /* @__PURE__ */ __name2(() => mealKitComponents, "mealKitComponents"),
  mealKitComponentsRelations: /* @__PURE__ */ __name2(() => mealKitComponentsRelations, "mealKitComponentsRelations"),
  mealKits: /* @__PURE__ */ __name2(() => mealKits, "mealKits"),
  mealKitsRelations: /* @__PURE__ */ __name2(() => mealKitsRelations, "mealKitsRelations"),
  mediaLibrary: /* @__PURE__ */ __name2(() => mediaLibrary, "mediaLibrary"),
  navigationItems: /* @__PURE__ */ __name2(() => navigationItems, "navigationItems"),
  nonDeliveryDays: /* @__PURE__ */ __name2(() => nonDeliveryDays, "nonDeliveryDays"),
  orderItems: /* @__PURE__ */ __name2(() => orderItems, "orderItems"),
  orderItemsRelations: /* @__PURE__ */ __name2(() => orderItemsRelations, "orderItemsRelations"),
  orders: /* @__PURE__ */ __name2(() => orders, "orders"),
  ordersRelations: /* @__PURE__ */ __name2(() => ordersRelations, "ordersRelations"),
  products: /* @__PURE__ */ __name2(() => products, "products"),
  productsRelations: /* @__PURE__ */ __name2(() => productsRelations, "productsRelations"),
  reviews: /* @__PURE__ */ __name2(() => reviews, "reviews"),
  serviceCategories: /* @__PURE__ */ __name2(() => serviceCategories, "serviceCategories"),
  serviceCategoriesRelations: /* @__PURE__ */ __name2(() => serviceCategoriesRelations, "serviceCategoriesRelations"),
  signupSchema: /* @__PURE__ */ __name2(() => signupSchema, "signupSchema"),
  siteContent: /* @__PURE__ */ __name2(() => siteContent, "siteContent"),
  siteSettings: /* @__PURE__ */ __name2(() => siteSettings, "siteSettings"),
  stores: /* @__PURE__ */ __name2(() => stores, "stores"),
  storesRelations: /* @__PURE__ */ __name2(() => storesRelations, "storesRelations"),
  users: /* @__PURE__ */ __name2(() => users, "users"),
  usersRelations: /* @__PURE__ */ __name2(() => usersRelations, "usersRelations")
});
...
var PgColumnBuilder = class extends ColumnBuilder {
  ...
  unique(name, config22) {
    this.config.isUnique = true;
    this.config.uniqueName = name;
    this.config.uniqueType = config22?.nulls;
    return this;
  }
...
var PgColumn = class extends Column {
  ...
  constructor(table32, config22) {
    if (!config22.uniqueName) {
      config22.uniqueName = uniqueKeyName(table32, [config22.name]);
    }
    super(table32, config22);
    this.table = table32;
  }
...
var PgArray = class _PgArray extends PgColumn {
  ...
  static {
    __name2(this, "_PgArray");
  }
  constructor(table32, config22, baseColumn, range) {
    super(table32, config22);
    this.baseColumn = baseColumn;
    this.range = range;
    this.size = config22.size;
  }
  size;
...
function isTable(table32) {
  return typeof table32 === "object" && table32 !== null && IsDrizzleTable in table32;
}
...
var ForeignKeyBuilder2 = class {
  ...
  static {
    __name2(this, "ForeignKeyBuilder2");
  }
...
var UniqueConstraintBuilder2 = class {
  ...
  static {
    __name2(this, "UniqueConstraintBuilder2");
  }
  constructor(columns, name) {
    this.name = name;
    this.columns = columns;
...
var UniqueOnConstraintBuilder2 = class {
  ...
  static {
    __name2(this, "UniqueOnConstraintBuilder2");
  }
...
var UniqueConstraint2 = class {
  ...
  static {
    __name2(this, "UniqueConstraint2");
  }
...
var SQLiteColumn = class extends Column {
  ...
  constructor(table32, config22) {
    if (!config22.uniqueName) {
      config22.uniqueName = uniqueKeyName2(table32, [config22.name]);
    }
    super(table32, config22);
    this.table = table32;
  }
...
var SelectionProxyHandler = class _SelectionProxyHandler {
  ...
  static {
    __name2(this, "_SelectionProxyHandler");
  }
...
function relations(table32, relations2) {
...
function createOne(sourceTable) {
  return /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function one(table32, config22) {
    return new One(
      sourceTable,
      table32,
      config22,
...
var SQLiteDialect = class {
  ...
  buildUpdateQuery({ table: table32, set, where, returning, withList, joins, from, limit, orderBy }) {
    const withSql = this.buildWithCTE(withList);
    const setSql = this.buildUpdateSet(table32, set);
    ...
    if (joins) {
      for (const [index, joinMeta] of joins.entries()) {
        ...
        if (is(table32, SQLiteTable)) {
          ...
          joinsArray.push(
            sql`${sql.raw(joinMeta.joinType)} join ${table32} on ${joinMeta.on}`
          );
        }
  ...
  buildFromTable(table32) {
    if (is(table32, Table) && table32[Table.Symbol.OriginalName] !== table32[Table.Symbol.Name]) {
      return sql`${sql.identifier(table32[Table.Symbol.OriginalName])} ${sql.identifier(table32[Table.Symbol.Name])}`;
    }
    return table32;
  }
  buildSelectQuery({
...
var SQLiteUpdateBase = class extends QueryPromise {
  ...
  constructor(table32, set, session, dialect, withList) {
    super();
    this.session = session;
    this.dialect = dialect;
    this.config = { set, table: table32, withList, joins: [] };
  }
...
var SQLiteCountBuilder = class _SQLiteCountBuilder extends SQL {
  ...
  static {
    __name2(this, "_SQLiteCountBuilder");
  }
  constructor(params) {
...
var SQLiteRelationalQuery = class extends QueryPromise {
  ...
  constructor(fullSchema, schema, tableNamesMap, table32, tableConfig, dialect, session, config22, mode) {
    super();
    this.fullSchema = fullSchema;
    this.schema = schema;
    this.tableNamesMap = tableNamesMap;
...
function isValidIP(ip, version222) {
  if ((version222 === "v4" || !version222) && ipv4Regex.test(ip)) {
    return true;
  }
  if ((version222 === "v6" || !version222) && ipv6Regex.test(ip)) {
    return true;
  }
  return false;
}
...
function isValidCidr(ip, version222) {
  if ((version222 === "v4" || !version222) && ipv4CidrRegex.test(ip)) {
    return true;
  }
  if ((version222 === "v6" || !version222) && ipv6CidrRegex.test(ip)) {
    return true;
  }
  return false;
}
...
var boolean = /* @__PURE__ */ __name2((name) => integer(name, { mode: "boolean" }), "boolean");
var timestamp = /* @__PURE__ */ __name2((name) => integer(name, { mode: "timestamp" }), "timestamp");
var products = sqliteTable("products", {
  id: integer("id", { mode: "number" }).primaryKey({ autoIncrement: true }),
  name: text("name").notNull(),
  // Default Mongolian name
  nameRu: text("name_ru"),
  // Russian name
  nameEn: text("name_en"),
  // English name
  description: text("description").notNull(),
  // Default Mongolian description
...
var signupSchema = insertUserSchema.extend({
  ...
  email: z.string().min(1, { message: "\u0418\u043C\u044D\u0439\u043B \u0445\u0430\u044F\u0433 \u0437\u0430\u0430\u0432\u0430\u043B \u0431\u0430\u0439\u0445 \u0451\u0441\u0442\u043E\u0439" }).email({ message: "\u0418\u043C\u044D\u0439\u043B \u0445\u0430\u044F\u0433 \u0431\u0443\u0440\u0443\u0443 \u0431\u0430\u0439\u043D\u0430" })
...
var bankAccounts = sqliteTable("bank_accounts", {
  id: integer("id", { mode: "number" }).primaryKey({ autoIncrement: true }),
...
var insertBankAccountSchema = createInsertSchema(bankAccounts).omit({
  ...
  return {
    ...
    isActive: data.isActive === void 0 ? true : data.isActive === true
  };
});
var navigationItems = sqliteTable("navigation_items", {
  id: integer("id", { mode: "number" }).primaryKey({ autoIncrement: true }),
  title: text("title").notNull(),
...
var insertNavigationItemSchema = createInsertSchema(navigationItems).omit({
  id: true,
  createdAt: true
});
...
var mediaLibrary = sqliteTable("media_library", {
  ...
  // dimensions, alt text, etc.
  createdAt: timestamp("created_at").defaultNow()
});
var insertMediaSchema = createInsertSchema(mediaLibrary).omit({
  id: true,
  createdAt: true
});
var footerSettings = sqliteTable("footer_settings", {
  id: integer("id", { mode: "number" }).primaryKey({ autoIncrement: true }),
  ...
  // Facebook, Twitter, Instagram, etc. URLs
  copyrightText: text("copyright_text").notNull(),
  quickLinks: text("quick_links", { mode: "json" }).default("[]"),
  // Array of { title, url } objects
  updatedAt: timestamp("updated_at").defaultNow()
});
var insertFooterSettingsSchema = createInsertSchema(footerSettings).omit({
  id: true,
  updatedAt: true
});
var siteSettings = sqliteTable("site_settings", {
  id: integer("id", { mode: "number" }).primaryKey({ autoIncrement: true }),
  key: text("key").notNull().unique(),
  // e.g., 'shipping_fee', 'currency_symbol'
...
var mealKits = sqliteTable("meal_kits", {
  id: integer("id", { mode: "number" }).primaryKey({ autoIncrement: true }),
  name: text("name").notNull(),
  description: text("description").notNull(),
  imageUrl: text("image_url").notNull(),
  price: real("price").notNull(),
  cookingTime: integer("cooking_time").notNull().default(30),
  // in minutes
...
var insertMealKitSchema = createInsertSchema(mealKits).omit({
  id: true,
  createdAt: true
});
var mealKitComponents = sqliteTable("meal_kit_components", {
  id: integer("id", { mode: "number" }).primaryKey({ autoIncrement: true }),
...
var insertMealKitComponentSchema = createInsertSchema(mealKitComponents).omit({
  id: true
});
var generatedMealKits = sqliteTable("generated_meal_kits", {
  id: integer("id", { mode: "number" }).primaryKey({ autoIncrement: true }),
  userId: integer("user_id"),
  // Can be null for non-logged-in users
  name: text("name").notNull(),
...
var insertGeneratedMealKitSchema = createInsertSchema(generatedMealKits).omit({
  id: true,
  createdAt: true
});
var generatedMealKitComponents = sqliteTable("generated_meal_kit_components", {
  id: integer("id", { mode: "number" }).primaryKey({ autoIncrement: true }),
...
var insertGeneratedMealKitComponentSchema = createInsertSchema(generatedMealKitComponents).omit({
  id: true
});
...
var mealKitComponentsRelations = relations(mealKitComponents, ({ one }) => ({
...
var mealKitsRelations = relations(mealKits, ({ many }) => ({
  components: many(mealKitComponents)
}));
var generatedMealKitComponentsRelations = relations(generatedMealKitComponents, ({ one }) => ({
...
var generatedMealKitsRelations = relations(generatedMealKits, ({ many, one }) => ({
...
var stores = sqliteTable("stores", {
  ...
  // References a service category (meat store, restaurant, etc)
  userId: integer("user_id").notNull(),
  // Store owner/admin user
  isActive: boolean("is_active").notNull().default(true),
...
var serviceCategories = sqliteTable("service_categories", {
  id: integer("id", { mode: "number" }).primaryKey({ autoIncrement: true }),
  name: text("name").notNull(),
  description: text("description").notNull(),
...
var nonDeliveryDays = sqliteTable("non_delivery_days", {
  id: integer("id", { mode: "number" }).primaryKey({ autoIncrement: true }),
...
var insertNonDeliveryDaySchema = createInsertSchema(nonDeliveryDays).omit({
  id: true,
  createdAt: true
});
var deliverySettings = sqliteTable("delivery_settings", {
  id: integer("id", { mode: "number" }).primaryKey({ autoIncrement: true }),
...
var insertDeliverySettingsSchema = createInsertSchema(deliverySettings).omit({
  id: true,
  updatedAt: true
});
...
var D1Storage = class {
  ...
  async updateServiceCategory(id, category) {
    const result = await this.db.update(serviceCategories).set(category).where(eq(serviceCategories.id, id)).returning();
    return result[0];
  }
  ...
  async updateStore(id, store) {
    const result = await this.db.update(stores).set(store).where(eq(stores.id, id)).returning();
    return result[0];
  }
  ...
  async getOrders(startDate, endDate) {
    ...
    if (conditions.length > 0) {
      return await this.db.select().from(orders).where(conditions.length > 1 ? and(...conditions) : conditions[0]).orderBy(desc(orders.createdAt));
    } else {
  ...
  async getOrdersWithItems(startDate, endDate) {
    ...
    }).from(orders).leftJoin(orderItems, eq(orders.id, orderItems.orderId)).leftJoin(products, eq(orderItems.productId, products.id)).orderBy(desc(orders.createdAt));
    const results = conditions.length > 0 ? await query.where(conditions.length > 1 ? and(...conditions) : conditions[0]) : await query;
  ...
  async createOrder(order, items) {
    try {
      ...
      for (const item of items) {
        ...
        const product = await this.getProduct(item.productId);
        if (product) {
          await this.db.update(products).set({ stock: product.stock - item.quantity }).where(eq(products.id, item.productId));
        }
      }
      return newOrder;
    } catch (error32) {
      console.error("Error in createOrder:", error32);
      throw error32;
    }
  }
  ...
  async getUserOrders(userId) {
    const userOrders = await this.db.select().from(orders).where(eq(orders.userId, userId)).orderBy(desc(orders.createdAt));
    const result = [];
  ...
  async getStats() {
    try {
      const [ordersCount] = await this.db.select({ count: sql`count(*)` }).from(orders);
      const [productsCount] = await this.db.select({ count: sql`count(*)` }).from(products);
      const [usersCount] = await this.db.select({ count: sql`count(*)` }).from(users);
      const [salesResult] = await this.db.select({ total: sql`sum(${orders.totalAmount})` }).from(orders);
      return {
      ...
      console.error("Error fetching stats:", error32);
      return {
        totalOrders: 0,
        totalSales: 0,
        totalProducts: 0,
  ...
  async updateSiteContent(id, content) {
    const result = await this.db.update(siteContent).set({
      ...content,
      updatedAt: /* @__PURE__ */ new Date()
    }).where(eq(siteContent.id, id)).returning();
    return result[0];
  }
  ...
  async getNavigationItemsTree() {
    ...
    const buildTree = /* @__PURE__ */ __name2((parentItems) => {
  ...
  async updateNavigationItem(id, item) {
    const result = await this.db.update(navigationItems).set(item).where(eq(navigationItems.id, id)).returning();
    return result[0];
  }
  async updateNavigationItemsOrder(itemIds) {
    try {
      for (let i = 0; i < itemIds.length; i++) {
        await this.db.update(navigationItems).set({ order: i }).where(eq(navigationItems.id, itemIds[i]));
      }
      return true;
    } catch (error32) {
      console.error("Error updating navigation item order:", error32);
      return false;
    }
  }
  ...
  async updateCategoriesOrder(categoryIds) {
    try {
      for (let i = 0; i < categoryIds.length; i++) {
        await this.db.update(categories).set({ order: i }).where(eq(categories.id, categoryIds[i]));
      }
      return true;
    } catch (error32) {
      console.error("Error updating category order:", error32);
      return false;
    }
  }
  ...
  async updateMediaItem(id, media) {
    const result = await this.db.update(mediaLibrary).set(media).where(eq(mediaLibrary.id, id)).returning();
    return result[0];
  }
  ...
  async updateSiteSetting(id, setting) {
    const result = await this.db.update(siteSettings).set({
      ...setting,
      updatedAt: /* @__PURE__ */ new Date()
    }).where(eq(siteSettings.id, id)).returning();
    return result[0];
  }
  ...
  async getDefaultBankAccount() {
    const result = await this.db.select().from(bankAccounts).where(eq(bankAccounts.isDefault, true)).limit(1);
    if (!result.length) {
  ...
  async createBankAccount(bankAccount) {
    if (bankAccount.isDefault) {
      await this.db.update(bankAccounts).set({ isDefault: false }).where(eq(bankAccounts.isDefault, true));
    }
    const dataToInsert = {
      ...
      isActive: bankAccount.isActive === void 0 ? true : bankAccount.isActive === true
    };
  ...
  async updateBankAccount(id, bankAccount) {
    if (bankAccount.isDefault) {
      await this.db.update(bankAccounts).set({ isDefault: false }).where(and(
        eq(bankAccounts.isDefault, true),
        not(eq(bankAccounts.id, id))
      ));
    }
    const dataToUpdate = {};
    if (bankAccount.bankName !== void 0) dataToUpdate.bankName = bankAccount.bankName;
    if (bankAccount.accountNumber !== void 0) dataToUpdate.accountNumber = bankAccount.accountNumber;
    if (bankAccount.accountHolder !== void 0) dataToUpdate.accountHolder = bankAccount.accountHolder;
    if (bankAccount.description !== void 0) dataToUpdate.description = bankAccount.description;
    if (bankAccount.isDefault !== void 0) dataToUpdate.isDefault = bankAccount.isDefault === true;
    if (bankAccount.isActive !== void 0) dataToUpdate.isActive = bankAccount.isActive === true;
    const result = await this.db.update(bankAccounts).set(dataToUpdate).where(eq(bankAccounts.id, id)).returning();
    return result[0];
  }
  ...
  async setDefaultBankAccount(id) {
    await this.db.update(bankAccounts).set({ isDefault: false }).where(eq(bankAccounts.isDefault, true));
    const result = await this.db.update(bankAccounts).set({ isDefault: true }).where(eq(bankAccounts.id, id)).returning();
    return result.length > 0;
  }
  // Footer settings methods
  async getFooterSettings() {
    const [footerSetting] = await this.db.select().from(footerSettings).limit(1);
    return footerSetting;
  }
  async updateFooterSettings(settings) {
    const existingSettings = await this.getFooterSettings();
    if (!existingSettings) {
      const [newSettings] = await this.db.insert(footerSettings).values({
        ...
        copyrightText: settings.copyrightText || `\xA9 ${(/* @__PURE__ */ new Date()).getFullYear()} \u0413\u0435\u0440\u0438\u043D \u041C\u0430\u0445. \u0411\u04AF\u0445 \u044D\u0440\u0445 \u0445\u0443\u0443\u043B\u0438\u0430\u0440 \u0445\u0430\u043C\u0433\u0430\u0430\u043B\u0430\u0433\u0434\u0441\u0430\u043D.`,
    ...
    const [updatedSettings] = await this.db.update(footerSettings).set({
      ...settings,
      updatedAt: /* @__PURE__ */ new Date()
    }).where(eq(footerSettings.id, existingSettings.id)).returning();
  ...
  async updateMealKit(id, mealKit) {
    const result = await this.db.update(mealKits).set(mealKit).where(eq(mealKits.id, id)).returning();
    return result[0];
  }
  ...
  async getMealKitComponents(mealKitId) {
    const components = await this.db.select().from(mealKitComponents).where(eq(mealKitComponents.mealKitId, mealKitId)).orderBy(asc(mealKitComponents.id));
    const componentsWithProducts = [];
  ...
  async updateMealKitComponent(id, component) {
    const result = await this.db.update(mealKitComponents).set(component).where(eq(mealKitComponents.id, id)).returning();
    return result[0];
  }
  ...
  async getGeneratedMealKits(userId, sessionId) {
    if (userId) {
      return await this.db.select().from(generatedMealKits).where(eq(generatedMealKits.userId, userId)).orderBy(desc(generatedMealKits.createdAt));
    } else if (sessionId) {
      return await this.db.select().from(generatedMealKits).where(eq(generatedMealKits.sessionId, sessionId)).orderBy(desc(generatedMealKits.createdAt));
    } else {
      return await this.db.select().from(generatedMealKits).orderBy(desc(generatedMealKits.createdAt));
    }
  }
  async getGeneratedMealKit(id) {
  ...
  async createGeneratedMealKit(mealKit, components) {
  ...
  async updateGeneratedMealKit(id, mealKit) {
    const result = await this.db.update(generatedMealKits).set(mealKit).where(eq(generatedMealKits.id, id)).returning();
    return result[0];
  }
  async deleteGeneratedMealKit(id) {
  ...
  async getGeneratedMealKitComponents(mealKitId) {
    const components = await this.db.select().from(generatedMealKitComponents).where(eq(generatedMealKitComponents.generatedMealKitId, mealKitId));
    const componentsWithProducts = [];
    for (const component of components) {
      const product = await this.getProduct(component.productId);
      if (product) {
    ...
    for (const productId of productIds) {
      ...
      if (product) {
        ...
        componentData.push({
          ...
          // Placeholder, updated in batch or subsequent step
          productId,
          quantity,
          price
        });
  ...
  async updateNonDeliveryDay(id, day) {
    const result = await this.db.update(nonDeliveryDays).set(day).where(eq(nonDeliveryDays.id, id)).returning();
    return result[0];
  }
  ...
  async updateDeliverySettings(settings) {
    ...
    const [updated] = await this.db.update(deliverySettings).set({
      ...settings,
      updatedAt: /* @__PURE__ */ new Date()
    }).where(eq(deliverySettings.id, existing.id)).returning();
    return updated;
  }
  // Review operations
  async getReviews() {
  ...
  async getApprovedReviews() {
    return await this.db.select().from(reviews).where(eq(reviews.isApproved, true)).orderBy(desc(reviews.createdAt));
  }
  async getReview(id) {
  ...
  async updateReview(id, review) {
    const result = await this.db.update(reviews).set(review).where(eq(reviews.id, id)).returning();
    return result[0];
  }
  ...
  async uploadFile(bucket, path, file) {
    ...
    try {
      ...
      console.error("R2 Upload Error:", error32);
      throw error32;
    }
  }
};
...
async function comparePasswords(supplied, stored) {
  try {
    ...
    console.error("Error comparing passwords:", error32);
    return false;
  }
}
__name(comparePasswords, "comparePasswords");
__name2(comparePasswords, "comparePasswords");
var app = new Hono2();
...
__name2(setUserSession, "setUserSession");
app.post("/login", async (c) => {
  try {
    ...
    let isValid2 = false;
    try {
      isValid2 = await comparePasswords(password, user.password);
    } catch (e) {
      return c.json({
        success: false,
    ...
    console.error("[Login] Unexpected error:", error32);
    return c.json({
      success: false,
...
app.post("/admin/login", async (c) => {
  try {
    ...
    console.error("[Admin Login] Unexpected error:", error32);
    return c.json({
      success: false,
      message: "Internal Server Error",
      error: error32.message
...
app.get("/setup-admin", async (c) => {
  try {
    ...
    if (user) {
      ...
      ).bind(username, email, hashedPassword, (/* @__PURE__ */ new Date()).toISOString()).run();
    }
    return c.json({
      success: true,
      ...
      credentials: {
        ...
        email,
        password
        // meaningful only if they used the default
      }
    });
  } catch (err) {
...
app.get("/user/orders", async (c) => {
  ...
  const storage = c.get("storage");
  const orders2 = await storage.getUserOrders(user.id);
  return c.json(orders2);
});
...
app2.post("/", requireAdmin, async (c) => {
  ...
  try {
    const productData = {
      ...
      thumbnailUrl: parsedData.thumbnailUrl || parsedData.thumbnail_url || body["thumbnailUrl"] || body["thumbnail_url"] || null,
    ...
    console.error("Error creating product:", error32);
    return c.json({
...
app2.put("/:id", requireAdmin, async (c) => {
  ...
  try {
    ...
    console.error("Error updating product:", error32);
    return c.json({
...
app3.get("/meal-kits", async (c) => {
  const storage = c.get("storage");
  const mealKits2 = await storage.getMealKits();
  return c.json(mealKits2);
});
...
app3.patch("/generated-meal-kits/:id", async (c) => {
  const storage = c.get("storage");
  const user = c.get("user");
  const id = parseInt(c.req.param("id"));
  const body = await c.req.json();
...
app3.delete("/generated-meal-kits/:id", async (c) => {
  const storage = c.get("storage");
  const user = c.get("user");
  const id = parseInt(c.req.param("id"));
  const kit = await storage.getGeneratedMealKit(id);
...
app3.get("/service-categories", async (c) => {
  const storage = c.get("storage");
  const categories2 = await storage.getServiceCategories();
  return c.json(categories2);
});
...
app3.get("/stores", async (c) => {
  ...
  if (categoryId) {
    const stores3 = await storage.getStoresByCategory(parseInt(categoryId));
    return c.json(stores3);
  }
...
var app4 = new Hono2();
app4.get("/orders/pending-count", requireAdmin, async (c) => {
  const storage = c.get("storage");
  const count32 = await storage.getPendingOrdersCount();
  return c.json({ count: count32 });
});
app4.get("/orders/stats", requireAdmin, async (c) => {
  const storage = c.get("storage");
...
app4.get("/orders", requireAdmin, async (c) => {
  ...
  const orders2 = await storage.getOrdersWithItems(startDate, endDate);
  return c.json(orders2);
});
...
app4.post("/orders", async (c) => {
  ...
  try {
    ...
    console.error("Order creation failed:", error32);
...
app5.get("/settings/login-images", async (c) => {
  const storage = c.get("storage");
...
app5.put("/settings/login-images", requireAdmin, async (c) => {
  const storage = c.get("storage");
  try {
    const body = await c.req.json();
    ...
    console.error("Error updating login images:", error32);
    return c.json({
...
// .wrangler/tmp/bundle-u9JETm/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-u9JETm/middleware-loader.entry.ts
...
//# sourceMappingURL=bundledWorker-0.36243289491220565.js.map
