...
export function AdminSidebar() {
  ...
  const mobileMenuToggle = (
    <div className="md:hidden fixed top-0 left-0 z-50 w-full bg-[#0d5c03] p-3 shadow-md flex justify-between items-center">
  ...
  return (
    <>
      ...
      <div className={cn(
        "fixed md:relative inset-y-0 left-0 z-40 w-80 md:w-64 bg-[#0d5c03] text-white shadow-xl transform transition-transform duration-300",
