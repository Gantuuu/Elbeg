      ...
      >
        <div className="relative overflow-hidden">
          ...
          <div className="absolute inset-0 bg-black bg-opacity-0 hover:bg-opacity-10 transition-all duration-300 flex items-end justify-end">
            <button
              className="m-2 bg-[#553511] text-white text-xs py-1.5 px-3 rounded-md flex items-center justify-center shadow-md font-bold"
        ...
        <div className="p-2.5">
          ...
          <div className="flex justify-end items-center mt-1">
            <p className="font-bold text-sm text-[#553511]">
              {formatPrice(price)}
            </p>
          </div>
        </div>
