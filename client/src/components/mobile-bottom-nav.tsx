          ...
          <div className="fixed top-0 left-0 right-0 bg-white shadow-lg z-50 max-h-[70vh] overflow-y-auto">
            <div className="px-4 pt-4 pb-3 space-y-1">
              ...
              <button
                ...
                className="block w-full text-left px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:text-[#0d5c03] hover:bg-gray-50 transition-all duration-200 border-l-2 border-transparent hover:border-[#0d5c03]/50"
              >
                {t.contact}
              </button>
              ...
              return (
                <button
                  ...
                  className={`group flex flex-col items-center justify-center py-2 px-6 rounded-xl transition-all duration-300 ease-out relative min-w-0 transform active:scale-95 hover:scale-105 ${isActive
                    ? "text-white bg-[#0d5c03] shadow-lg shadow-[#0d5c03]/30"
                    : "text-gray-600 hover:text-white hover:bg-[#0d5c03]/80 hover:shadow-md hover:shadow-[#0d5c03]/20"
                    }`}
                >
                  <div className="relative mb-1 transition-transform duration-300 group-active:scale-110">
                    ...
                    {item.badge && (
                      <span className="absolute -top-2 -right-2 bg-[#0d5c03] text-white text-xs rounded-full h-5 w-5 flex items-center justify-center shadow-lg animate-pulse">
