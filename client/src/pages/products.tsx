  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="pt-20">
        {/* Hero Section */}
        <div className="bg-[#553511] text-white py-16">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          {isLoading ? (
            <div className="flex justify-center items-center py-20">
              <div className="animate-spin rounded-full h-12 w-12 border-4 border-[#553511] border-t-transparent"></div>
            </div>
              ...
              {Object.entries(productsByCategory).map(([category, categoryProducts]) => (
                <div key={category} className="space-y-6">
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1 h-px bg-[#553511]"></div>
          ...
          <div className="text-center mt-16">
            <Link href="/">
              <Button
                variant="outline"
                size="lg"
                className="bg-white hover:bg-gray-50 border-2 border-gray-200 text-gray-700 hover:text-[#553511] transition-all duration-200"
              >
