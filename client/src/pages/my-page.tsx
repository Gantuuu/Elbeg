...
export default function MyPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <div className="w-full bg-[#3c8fb8] py-8 mb-8">
                ...
                {isOrdersLoading ? (
                  ...
                  <div className="py-12 text-center">
                    ...
                    <Button
                      ...
                      className="mt-4 bg-[#3c8fb8] text-white hover:opacity-90"
                    >
                      {t.retry}
                    </Button>
                  </div>
                  ...
                  <div className="py-12 text-center">
                    <div className="w-20 h-20 rounded-full bg-[#3c8fb8] flex items-center justify-center mx-auto mb-4">
                    ...
                    <Button
                      onClick={() => setLocation("/")}
                      className="mt-2 bg-[#3c8fb8] text-white hover:brightness-105 transition-all"
                    >
                      {t.viewProducts}
                    </Button>
                  </div>
          ...
          <Button
            ...
            className={
              expanded
                ...
                : "bg-[#3c8fb8] text-white hover:brightness-105 transition-all"
            }
            size="sm"
          >
