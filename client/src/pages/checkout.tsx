      ...
      <div className="min-h-screen bg-background">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="text-center py-10 bg-white rounded-xl shadow-sm">
            <span className="material-icons text-5xl text-[#553511] mb-4">shopping_cart</span>
            ...
            <Button
              onClick={() => setLocation("/")}
              className="bg-[#553511] hover:brightness-105 text-white font-medium transition-all duration-300 shadow-sm hover:shadow-md"
            >
              Бүтээгдэхүүн харах
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="py-12 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="text-center mb-8">
          <h1 className="text-3xl md:text-4xl font-bold text-[#553511] inline-block mb-3">{t.checkout}</h1>
          <div className="w-20 h-1 bg-[#553511] mx-auto rounded-full"></div>
        </div>
            ...
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                ...
                <div className="space-y-4 rounded-lg p-5 border-2 border-blue-400/70 bg-white shadow-md">
                  <div className="flex items-center bg-[#553511] px-4 py-2 rounded-md -mt-2 -mx-1 shadow-sm">
                  ...
                  <div className="mb-6">
                    <h3 className="text-lg font-bold text-[#553511] inline-block mb-3">{t.bankTransfer}</h3>
                        ...
                        <FormItem className="mb-4">
                          <div className="flex items-center justify-between mb-2">
                            <FormLabel className="text-gray-800 font-medium flex items-center">
                              <span className="material-icons text-[#553511] mr-1 text-lg">account_balance</span>
                              {t.bank}
                            </FormLabel>
                          ...
                          >
                            <FormControl>
                              <SelectTrigger className="bg-white border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-[#553511]/20 focus:border-[#553511]">
                            ...
                            <SelectContent className="rounded-xl border-2 border-gray-200 shadow-lg bg-white">
                              {isBankAccountsLoading ? (
                                <div className="p-4 text-center">
                                  <div className="h-4 w-24 bg-[#553511]/10 animate-pulse rounded-full mx-auto mb-2"></div>
                                  <div className="h-4 w-36 bg-[#553511]/10 animate-pulse rounded-full mx-auto"></div>
                                </div>
                      ...
                      <div className="rounded-xl overflow-hidden shadow-md bg-white border border-gray-100">
                        {(() => {
                          ...
                          if (accountData) {
                            return (
                              <>
                                <div className="bg-[#553511] p-3 text-white">
                                ...
                                <div className="p-4">
                                  <div className="flex flex-col space-y-4">
                                    ...
                                    <button
                                      ...
                                      className="flex items-center justify-center py-2 px-4 rounded-lg bg-[#553511] text-white hover:brightness-110 font-medium text-sm transition-all duration-300 shadow-sm hover:shadow-md mt-2"
                                    >
                ...
                <Button
                  type="submit"
                  className="w-full bg-[#553511] hover:brightness-105 text-white font-medium py-6 transition-all duration-300 shadow-sm hover:shadow-md"
            ...
            <div className="bg-white rounded-xl shadow-sm p-6 mb-6 border border-gray-100">
              ...
              <div className="border-t border-gray-100 pt-4">
                ...
                <div className="flex justify-between text-lg font-bold mt-4 pt-4 border-t border-gray-100">
                  ...
                  <span className="text-[#553511] font-bold">{formatPrice(totalPrice + shippingFee)}</span>
                </div>
              </div>
            </div>
