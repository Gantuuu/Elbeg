      ...
      <div className="flex-1 overflow-hidden flex flex-col">
        ...
        <div className="p-6 overflow-auto flex-1">
          <Card className="shadow-md max-w-4xl">
            <CardHeader>
              <CardTitle className="text-[#3c8fb8]">
            ...
            <CardContent>
              {isLoading ? (
                <div className="flex justify-center py-12">
                  <Loader2 className="h-8 w-8 animate-spin text-[#3c8fb8]" />
                </div>
              ) : (
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between border-t pt-4">
                    <div className="flex items-center gap-2">
                      ...
                      <Button
                        type="button"
                        variant="outline"
                        className="border-[#3c8fb8] text-[#3c8fb8] hover:bg-[#3c8fb8]/10"
                        onClick={() =>
                    ...
                    <Button
                      type="submit"
                      className="bg-[#3c8fb8] hover:bg-[#084130] min-w-[120px]"
          ...
          {!isLoading && loginImages.trim() && (
            <div className="mt-8">
              <h3 className="text-lg font-semibold mb-4 text-[#3c8fb8]">
                Урьдчилсан харагдац
              </h3>
