...
const SMS_TEMPLATES: Record<string, (amount: string) => string> = {
  pending: (amount) => `[Содон хүнс] Таны ${amount} төлбөр төлөгдөөгүй байна. Төлбөрөө баталгаажуулна уу.`,
  payment_confirmed: (amount) => `[Содон хүнс] Таны ${amount} төлбөр төлөгдлөө. Захиалга бэлтгэгдэж байна.`,
  processing: (amount) => `[Содон хүнс] Таны ${amount} төлбөр төлөгдлөө. Захиалга бэлтгэгдэж байна.`,
  shipped: () => `[Содон хүнс] Таны захиалга хүргэлтэд гарлаа.`,
  delivered: () => `[Содон хүнс] Таны захиалга амжилттай хүргэгдлээ. Баярлалаа.`,
  cancelled: () => `[Содон хүнс] Таны захиалга цуцлагдсан байна.`,
};
